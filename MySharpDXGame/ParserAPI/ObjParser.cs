...
namespace ObjParse
{
    public class ObjParser
    {
        ...
        public JVector WorldPos { get; set; }
        public JQuaternion worldRot { get; set; }
                    ...
                    case "worldpos":
                        {
                            ...
                            WorldPos = new JVector(x, y, z);
                            break;
                        }
                    case "worldrot":
                        {
                            float rotX = float.Parse(parts[1]);
                            float rotY = float.Parse(parts[2]);
                            float rotZ = float.Parse(parts[3]);
                            float rotW = float.Parse(parts[4]);

                            worldRot = new JQuaternion(rotX, rotY, rotZ, rotW);
                            break;
                        }
                    case "usemtl":
                        UseMtl = parts[1];
